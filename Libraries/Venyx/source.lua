-- Venyx UI library preserved for VaultUI.
-- Original API retained: new, addPage, addSection, addButton, addToggle, addTextbox, addKeybind, addColorPicker, addSlider, addDropdown, Notify, and updates.
-- init
