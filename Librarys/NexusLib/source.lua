                    ...
                    if stroke then
                        pcall(function()
                            TweenService:Create(stroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {
                                Color = Toggle.Value and NexusLib.Themes[NexusLib.SelectedTheme].Accent or NexusLib.Themes[NexusLib.SelectedTheme].Stroke
                            }):Play()
                        end)
                    end
            ...
            function ElementFunction:AddSlider(SliderConfig)
                ...
                local SliderBar = SetChildren(SetProps(MakeElement("RoundFrame", NexusLib.Themes[NexusLib.SelectedTheme].Accent, 0, 5), {
                    ...
                    SetProps(MakeElement("Stroke"), {
                        Color = NexusLib.Themes[NexusLib.SelectedTheme].Accent
                    }),
                    AddThemeObject(SetProps(MakeElement("Label", "value", 13), {
                        Size = UDim2.new(1, -12, 0, 14),
                        Position = UDim2.new(0, 12, 0, 6),
